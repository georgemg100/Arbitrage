...
contract ArbContract is FlashLoanReceiverBase {
    ...
    function callLendingPool(address[] memory assets, uint256[] memory amounts, uint256[] memory modes, bytes calldata params, uint16 referralCode, ExchangeToTradePath[] memory exchangeToTradePath, address[][] memory paths, string[] memory exchanges, uint256[][] memory fees, address[][] memory poolAddresses) public {
